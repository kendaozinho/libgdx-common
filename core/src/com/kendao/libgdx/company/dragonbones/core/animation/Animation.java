...
import com.kendao.libgdx.company.dragonbones.core.core.AnimationFadeOutMode;
import com.kendao.libgdx.company.dragonbones.core.core.BaseObject;
import com.kendao.libgdx.company.dragonbones.core.model.AnimationConfig;
import com.kendao.libgdx.company.dragonbones.core.model.AnimationData;
...
public class Animation extends BaseObject {
  ...
  public AnimationState fadeIn(
      ...
      int layer, String group, AnimationFadeOutMode fadeOutMode
  ) {
    this._animationConfig.clear();
  ...
  public AnimationState gotoAndStopByFrame(String animationName) {
   ...
   * @see AnimationState
   */
  public AnimationState gotoAndStopByFrame(String animationName, int frame) {
  ...
  public AnimationState gotoAndStop(String animationName) {
   ...
   * @deprecated 已废弃，请参考 @see
   */
  public AnimationState gotoAndStop(String animationName, float time) {
