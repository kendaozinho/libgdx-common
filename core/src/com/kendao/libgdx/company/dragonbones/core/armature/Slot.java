...
public abstract class Slot extends TransformObject {
   ...
   * @private
   */
  public void _setArmature(Armature value) {
   ...
   * @private
   */
  public boolean _setDisplayList(Array<Object> value) {
   ...
   * @private
   */
  public void init(SlotData slotData, Array<DisplayData> displayDatas, Object rawDisplay, Object meshDisplay) {
