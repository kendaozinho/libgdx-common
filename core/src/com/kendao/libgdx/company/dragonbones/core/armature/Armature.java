...
import com.kendao.libgdx.company.dragonbones.core.animation.Animation;
import com.kendao.libgdx.company.dragonbones.core.animation.IAnimatable;
...
public class Armature extends BaseObject implements IAnimatable {
   ...
   * @private
   */
  public void _sortZOrder(ShortArray slotIndices, int offset) {
   ...
   * @see Slot
   */
  public void invalidUpdate(String boneName, boolean updateSlotDisplay) {
  ...
  public void clock(WorldClock value) {
