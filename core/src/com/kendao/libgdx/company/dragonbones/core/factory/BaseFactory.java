package com.kendao.libgdx.company.dragonbones.core.factory;
...
import com.kendao.libgdx.company.dragonbones.core.armature.IKConstraint;
...
import com.kendao.libgdx.company.dragonbones.core.model.*;
import com.kendao.libgdx.company.dragonbones.core.parser.BinaryDataParser;
import com.kendao.libgdx.company.dragonbones.core.parser.DataParser;
import com.kendao.libgdx.company.dragonbones.core.parser.ObjectDataParser;
...
public abstract class BaseFactory {
   ...
   * @see TextureAtlasData
   */
  public TextureAtlasData parseTextureAtlasData(Object rawData, Object textureAtlas, String name, float scale) {
    TextureAtlasData textureAtlasData = this._buildTextureAtlasData(null, null);
  ...
  public Armature buildArmature(String armatureName, String dragonBonesName, String skinName, String textureAtlasName) {
    BuildArmaturePackage dataPackage = new BuildArmaturePackage();
   ...
   * @see SkinData
   */
  public void changeSkin(Armature armature, SkinData skin, Array<String> exclude) {
  ...
  public boolean copyAnimationsToArmature(
      ...
      String fromSkinName,
      String fromDragonBonesDataName,
